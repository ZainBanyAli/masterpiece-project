        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="review">
                    <div class="set">
                        @php
                        $package_rating = $package->total_score/$package->total_rating;// calculate finale rating
                        @endphp
                        @for($i=1; $i<=5; $i++)
                            @if($i <= $package_rating)
                                ...
                                <div class="row">
                                    @foreach($package_videos as $item)
                                        <div class="col-md-6 col-lg-6">
                                            <div class="item">
                                                <!-- Add magnific-video class here -->
                                                <a class="magnific-video" href="http://www.youtube.com/watch?v={{ $item->video }}">
...
<!-- Include SweetAlert in your layout -->
...
<!-- SweetAlert Success or Error Alert -->
@if (session('success'))
    <script>
        Swal.fire({
            icon: 'success',
...
{{--  --}}
                        ...
                        <div class="tab-pane fade" id="tab-8-pane" role="tabpanel" aria-labelledby="tab-8" tabindex="0">
                            <!-- Booking -->
                            {{-- if there is no tour ,booking hidden --}}
                            @if($tours->count() > 0)
