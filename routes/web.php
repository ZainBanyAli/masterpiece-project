...
// Admin routes that require the admin middleware
Route::middleware('admin')->prefix('admin')->group(function () {
    // Profile routes
    Route::get('/profile', [AdminAuthController::class, 'editProfile'])->name('admin_profile');
    Route::post('/profile/update', [AdminAuthController::class, 'updateProfile'])->name('admin_profile_submit');
    ...
    Route::get('/slider/create',[AdminSliderController::class,'create'])->name('admin_slider_create');//add new slider
