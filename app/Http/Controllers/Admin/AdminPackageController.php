...
class AdminPackageController extends Controller
{
    ...
    public function package_amenities($id)
    {
        ...
        // $package_amenities_include = PackageAmenity::with('amenity')->where('type', 'include')->get();
        // $package_amenities_exclude = PackageAmenity::with('amenity')->where('type', 'exclude')->get();
